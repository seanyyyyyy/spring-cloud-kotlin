...
class GreetingRestTemplateTest(@Autowired val testRestTemplate: TestRestTemplate) {

    @Test
    fun whenCalledShouldReturnHelloService() {
        val result = testRestTemplate
                .withBasicAuth("user","pass")
                .getForEntity<String>("/greeting")
        assertThat(result.statusCode).isEqualTo(HttpStatus.OK)
        assertThat(result.body).contains("Greetings, World!")
    }
}